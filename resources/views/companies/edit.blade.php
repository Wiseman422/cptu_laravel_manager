                ...
                <div class="row col-md-12 col-lg-12 col-sm-12" style="background: white; margin:10px;">
                    <form method="post" action="{{ route('companies.update', [$company->id]) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="company-name" placeholder="Enter Name" name="name" required value="{{ $company->name }}" spellcheck="false" />
                        </div>
                        <div class="form-group">
                            <label for="description">Name<span class="require">*</span></label>
                            <textarea class="form-control text-left" rows="5" cols="80" id="description" name="description" placeholder="Enter description">{{ $company->description }}</textarea>
                        </div>
                        <div class="form-group">
